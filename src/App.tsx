    ...
    <div className="flex justify-center items-center w-screen h-[80vh] md:h-screen p-2 lg:bg-[url('./assets/background.jpg')]">
      <div className="bg-white w-screen md:w-[32rem] lg:w-[32rem] px-7 lg:px-10 py-3 lg:py-5 flex flex-col gap-3 rounded-xl shadow-md ">
        ...
        <div className='w-100 flex flex-col gap-2'>
          <input type='number' value={phone} onChange={(e) => { setPhone(e.target.value), setShowPhoneError(false) }} className='border-none shadow-md rounded-lg h-10 pl-2 pr-2 w-full' placeholder='Escribe el número de teléfono' />
          {showPhoneError && (
        ...
        <button onClick={() => sendWhatsappMessage()}
          className='flex  bg-green-600 text-white hover:bg-green-700/90 focus:outline-none ffocus:border-transparent focus:ring-0 gap-2 justify-center p-2 rounded-lg shadow-md text-md px-5 py-2.5 font-semibold items-center dark:focus:ring-[#3b5998]/55"'>
